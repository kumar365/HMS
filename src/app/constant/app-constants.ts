...
export class AppConstants {
    ...
    public static LAB_TEST_URL = AppConstants.API_BASE_URL + "labTest/";
    public static ADD_TEST_DETAILS = AppConstants.LAB_TEST_URL + 'addTestDetails';
    public static GET_TEST_DETAILS_BY_ID = AppConstants.LAB_TEST_URL + 'getTestDetailsById/';
    public static DELETE_TEST_DETAILS_BY_ID = AppConstants.LAB_TEST_URL + 'deleteTestDetailsById/';
